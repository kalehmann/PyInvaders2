...
class BuildExe:
    def __init__(self):
        ...
        self.copyright = "Copyright (c) 2014 Karsten Lehmann."
 
        #Description
        self.project_description = ""
 
        #Icon file (None will use pygame default icon)
        self.icon_file = "pyin.ico"
 
        #Extra files/dirs copied to game
        self.extra_datas = ["textures", "sound", "levels", "icon.png"]
